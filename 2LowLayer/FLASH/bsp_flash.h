...
//GPIOA define
#define MR_PORT			GPIOC
#define MR_PORT_CS		GPIOC

#define MR_CS_PIN		GPIO_Pin_8
#define MR_SCK_PIN		GPIO_Pin_10
#define MR_MISO_PIN		GPIO_Pin_11
#define MR_MOSI_PIN		GPIO_Pin_12

#define MR_CS_PINSource		GPIO_PinSource8
#define MR_SCK_PINSource	GPIO_PinSource10
#define MR_MISO_PINSource	GPIO_PinSource11
#define MR_MOSI_PINSource	GPIO_PinSource12
...
#define	FLASH_CS 			PCout(8)  	//W25QXX的片选信号
