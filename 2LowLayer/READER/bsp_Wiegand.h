...
#define WG1_IN_D0       GPIO_Pin_7//韦根接口
#define WG1_IN_D1       GPIO_Pin_6//韦根接口
#define WG1_PortSource   EXTI_PortSourceGPIOB
#define WG1_IN_D0_PinSource EXTI_PinSource7
#define WG1_IN_D1_PinSource EXTI_PinSource6
#define WG1_IN_D0_EXTI  EXTI_Line7//韦根接口
#define WG1_IN_D1_EXTI  EXTI_Line6//韦根接口


#define WG2_RCC         RCC_AHB1Periph_GPIOB
#define WG2_GPIO_PORT   GPIOB
#define WG2_IN_D0       GPIO_Pin_9//韦根接口
#define WG2_IN_D1       GPIO_Pin_8//韦根接口
#define WG2_PortSource   EXTI_PortSourceGPIOB
#define WG2_IN_D0_PinSource EXTI_PinSource9
#define WG2_IN_D1_PinSource EXTI_PinSource8
#define WG2_IN_D0_EXTI  EXTI_Line9//韦根接口
#define WG2_IN_D1_EXTI  EXTI_Line8//韦根接口
